 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_sl')){
	function azrcrv_create_plugin_menu_sl(){
		azrcrv_create_plugin_menu_table_sl();
		azrcrv_populate_plugin_menu_table_sl();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_sl')){
	function azrcrv_populate_plugin_menu_table_sl(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_sl')){
	function azrcrv_create_plugin_menu_table_sl(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
