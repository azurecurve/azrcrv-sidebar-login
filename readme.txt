...
Download link:	https://github.com/azurecurve/azrcrv-sidebar-login/releases/download/v1.3.4/azrcrv-sidebar-login.zip
...
### [Version 1.3.4](https://github.com/azurecurve/azrcrv-sidebar-login/releases/tag/v1.3.4)
 * Update readme files.
